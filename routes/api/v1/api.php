...
use App\Http\Controllers\Api\V1\History\GetClosedTransactionsController;
...
Route::prefix('v1')->group(function () {
    Route::group(['middleware' => 'auth:sanctum', 'api'], function () {
        Route::group(['prefix' => 'transactions', 'name' => 'transactions.'], function () {
            ...
            Route::get('/histories/{history}', GetClosedTransactionsController::class)->name('closed.month');
        });
