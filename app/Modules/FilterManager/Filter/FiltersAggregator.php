...
final class FiltersAggregator
{
    ...
    public function addFilter(FilterableDTO $dto): self
    {
    ...
    public function getFilterables(string $key = null): array|FilterableDTO
    {
        if ($key) {
            return Arr::first($this->filterables, fn(FilterableDTO $dto) => $dto->field === $key) ?? [];
        }
    ...
    public static function forFiltering(FilterableDTO $dto): self
    {
